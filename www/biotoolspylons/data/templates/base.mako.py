...
def render_body(context,**pageargs):
    ...
    try:
        ...
        # SOURCE LINE 15
        __M_writer(unicode(h.rails.link_to("Fasta Files", h.url_for(controller='fastas', action="index") ) ))
        __M_writer(u'  \n          | ')
        # SOURCE LINE 16
        __M_writer(unicode(h.rails.link_to("Upload Fasta File", h.url_for(controller='fastas', action="new") ) ))
        __M_writer(u'  \n          | ')
        # SOURCE LINE 17
        __M_writer(unicode(h.rails.link_to("Blast Files", h.url_for(controller='miniblast') ) ))
